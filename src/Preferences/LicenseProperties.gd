...
""".format(
	{
		...
		"attribution_required": "Yes" if licenses[license]["attribution_required"] else "Optional",
		"commercial_use_allowed": "Allowed" if licenses[license]["commercial_use_allowed"] else "Forbidden",
		"derivatives_allowed": "Allowed" if licenses[license]["derivatives_allowed"] else "Forbidden",
		"share_alike_required": "Yes" if licenses[license]["share_alike_required"] else "No"
	}
)
