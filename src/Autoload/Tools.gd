...
var tools := {
	...
	"Move": Tool.new("Move", "Move", "move", preload("res://src/Tools/CanvasTools/Move.tscn")),
	"Zoom": Tool.new("Zoom", "Zoom", "zoom", preload("res://src/Tools/CanvasTools/Zoom.tscn")),
	"Pan": Tool.new("Pan", "Pan", "pan", preload("res://src/Tools/CanvasTools/Pan.tscn")),
	"ColorPicker":
	Tool.new(
		"ColorPicker",
		"Color Picker",
		"colorpicker",
		preload("res://src/Tools/DrawTools/ColorPicker.tscn"),
	...
	Tool.new(
		...
		"Pencil",
		"pencil",
		preload("res://src/Tools/DrawTools/Pencil.tscn"),
	...
	Tool.new(
		...
		"Eraser",
		"eraser",
		preload("res://src/Tools/DrawTools/Eraser.tscn"),
		"Hold %s to make a line",
		["draw_create_line"]
	),
	"Bucket": Tool.new("Bucket", "Bucket", "fill", preload("res://src/Tools/Bucket/Bucket.tscn")),
	"Shading":
	Tool.new("Shading", "Shading Tool", "shading", preload("res://src/Tools/DrawTools/Shading.tscn")),
	"LineTool":
	Tool.new(
		"LineTool",
		"Line Tool",
		"linetool",
		preload("res://src/Tools/DrawTools/ShapeTools/LineTool.tscn"),
...
Hold %s to displace the shape's origin""",
	...
	Tool.new(
		...
		"Rectangle Tool",
		"rectangletool",
		preload("res://src/Tools/DrawTools/ShapeTools/RectangleTool.tscn"),
...
Hold %s to displace the shape's origin""",
	...
	Tool.new(
		...
		"Ellipse Tool",
		"ellipsetool",
		preload("res://src/Tools/DrawTools/ShapeTools/EllipseTool.tscn"),
		"""Hold %s to create a 1:1 shape
Hold %s to center the shape on the click origin
Hold %s to displace the shape's origin""",
		["shape_perfect", "shape_center", "shape_displace"]
