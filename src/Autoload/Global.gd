...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_rectangle_select_tool")[0].as_text(),
			InputMap.get_action_list("right_rectangle_select_tool")[0].as_text()
		]
	)

	var ellipse_select: BaseButton = tool_buttons.find_node("EllipseSelect")
	ellipse_select.hint_tooltip = (
		tr(
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_ellipse_select_tool")[0].as_text(),
			InputMap.get_action_list("right_ellipse_select_tool")[0].as_text()
		]
	)

	var polygon_select: BaseButton = tool_buttons.find_node("PolygonSelect")
	polygon_select.hint_tooltip = (
		tr(
			"""Polygonal Selection
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_polygon_select_tool")[0].as_text(),
			InputMap.get_action_list("right_polygon_select_tool")[0].as_text()
		]
	)

	var color_select: BaseButton = tool_buttons.find_node("ColorSelect")
	color_select.hint_tooltip = (
		tr(
			"""Select By Color
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_color_select_tool")[0].as_text(),
			InputMap.get_action_list("right_color_select_tool")[0].as_text()
		]
	)

	var magic_wand: BaseButton = tool_buttons.find_node("MagicWand")
	magic_wand.hint_tooltip = (
		tr(
			"""Magic Wand
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_magic_wand_tool")[0].as_text(),
			InputMap.get_action_list("right_magic_wand_tool")[0].as_text()
		]
	)
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_lasso_tool")[0].as_text(),
			InputMap.get_action_list("right_lasso_tool")[0].as_text()
		]
	)

	var move_select: BaseButton = tool_buttons.find_node("Move")
	move_select.hint_tooltip = (
		tr(
			"""Move
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_move_tool")[0].as_text(),
			InputMap.get_action_list("right_move_tool")[0].as_text()
		]
	)

	var zoom_tool: BaseButton = tool_buttons.find_node("Zoom")
	zoom_tool.hint_tooltip = (
		tr(
			"""Zoom
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_zoom_tool")[0].as_text(),
			InputMap.get_action_list("right_zoom_tool")[0].as_text()
		]
	)

	var pan_tool: BaseButton = tool_buttons.find_node("Pan")
	pan_tool.hint_tooltip = (
		tr(
			"""Pan
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_pan_tool")[0].as_text(),
			InputMap.get_action_list("right_pan_tool")[0].as_text()
		]
	)
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_colorpicker_tool")[0].as_text(),
			InputMap.get_action_list("right_colorpicker_tool")[0].as_text()
		]
	)
...
Hold %s to make a line"""
		...
		% [
			InputMap.get_action_list("left_pencil_tool")[0].as_text(),
			InputMap.get_action_list("right_pencil_tool")[0].as_text(),
			"Shift"
		]
	)
...
Hold %s to make a line"""
		...
		% [
			InputMap.get_action_list("left_eraser_tool")[0].as_text(),
			InputMap.get_action_list("right_eraser_tool")[0].as_text(),
			"Shift"
		]
	)
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_fill_tool")[0].as_text(),
			InputMap.get_action_list("right_fill_tool")[0].as_text()
		]
	)
...
%s for right mouse button"""
		...
		% [
			InputMap.get_action_list("left_shading_tool")[0].as_text(),
			InputMap.get_action_list("right_shading_tool")[0].as_text()
		]
	)

	var linetool: BaseButton = tool_buttons.find_node("LineTool")
	linetool.hint_tooltip = (
		tr(
			"""Line Tool
...
Hold %s to displace the shape's origin"""
		...
		% [
			InputMap.get_action_list("left_linetool_tool")[0].as_text(),
			InputMap.get_action_list("right_linetool_tool")[0].as_text(),
			"Shift",
			"Ctrl",
			"Alt"
		]
...
Hold %s to displace the shape's origin"""
		...
		% [
			InputMap.get_action_list("left_rectangletool_tool")[0].as_text(),
			InputMap.get_action_list("right_rectangletool_tool")[0].as_text(),
			"Shift",
			"Ctrl",
			"Alt"
		]
...
Hold %s to displace the shape's origin"""
		...
		% [
			InputMap.get_action_list("left_ellipsetool_tool")[0].as_text(),
			InputMap.get_action_list("right_ellipsetool_tool")[0].as_text(),
			"Shift",
			"Ctrl",
			"Alt"
		]
