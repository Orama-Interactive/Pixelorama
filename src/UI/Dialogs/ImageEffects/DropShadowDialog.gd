...
func commit_action(cel: Image, project: Project = Global.current_project) -> void:
	var offset_x = animate_panel.get_animated_values(commit_idx, confirmed)[Animate.OFFSET_X]
	var offset_y = animate_panel.get_animated_values(commit_idx, confirmed)[Animate.OFFSET_Y]
