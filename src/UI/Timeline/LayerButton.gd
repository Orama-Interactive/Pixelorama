...
func _on_visibility_button_pressed() -> void:
	...
	if Input.is_key_pressed(KEY_ALT):
		...
		for other_layer in Global.current_project.layers:
			...
			project.undo_redo.add_do_property(other_layer, "hidden_by_other_layer", not one_hidden_by_other_layer)
			project.undo_redo.add_undo_property(other_layer, "hidden_by_other_layer", other_layer.hidden_by_other_layer)
	else:
